...
struct MyAppWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = MyAppWidgetAttributes(name: "Me")
    static let contentState = MyAppWidgetAttributes.ContentState(value: 3)
